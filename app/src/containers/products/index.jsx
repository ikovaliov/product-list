...
import { Grid, Container, Select, InputLabel, FormControl, MenuItem } from '@material-ui/core';
...
class ProductContainer extends Component {
  ...
  render() {
    const { loader, items, currentPage, totalCount, perPage, sortByPrice } = this.props;
        ...
        <Container>
         <FormControl>
          ...
          <div className="product-list--pages">
            <Pagination count={pages.length} page={currentPage} variant="outlined" shape="rounded" onChange={(e,val) => this.props.setCurrentPage(val)}/>
          </div> 
        </Container>
      </div>
    );
